document.getElementById('fetchButton').addEventListener('click', function() {
    ...
    const url = 'https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=71b1966355ddca4fec1345cac864a220&text='+searchKey+'&format=json&nojsoncallback=1&extras=url_s';
